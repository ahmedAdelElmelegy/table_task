...
class FormItemMobile extends StatefulWidget {
  final int index;
  const FormItemMobile({super.key, required this.index});

  @override
  State<FormItemMobile> createState() => _FormItemMobileState();
}

class _FormItemMobileState extends State<FormItemMobile>
            ...
            children: [
              ...
              CustomInputField(
                ...
                asyncItems: (filter, page) async {
                  return [
                    'Tag 1sdfffffffffffffffffffffffffffffffffff',
                    'Tag 2',
                    'Tag 3',
                    'Tag 4',
                    'Tag 5',
